...
class RecipeUI {
    ...
    render(data){
        ...
        `<div class="card shadow-lg rounded my-1 mx-auto">
            <img src="assets/img/${data.imgName}" class="time card-img-top" width="250" height="250">
            <i class="far fa-plus-square fa-2x add"></i>
            <div class="icon bg-light mx-auto text-centre">
                <img src="" alt="">
            </div>
            <div class="text-muted text-uppercase text-center details">
                <h6 class="my-2 recipe-title">${data.title}</h6>
                <div class="my-1">${data.type}</div>
            </div>
        </div>
        `;
    ...
    getList(data, addedRecipe){

        if(data.title === addedRecipe){

            // veg list sorting
            if(this.vegArray.length == 0){
                this.vegArray = data.vegIngredients;
            } else {
                data.vegIngredients.forEach(item => {
            ...
            if(this.shopArray.length == 0){
                this.shopArray = data.shopIngredients;
            } else {
                data.shopIngredients.forEach(item => {
            ...
            if(this.spiceArray.length == 0){
                this.spiceArray = data.spiceIngredients;
            } else {
                data.spiceIngredients.forEach(item => {
    ...
    removeItem(element, array){
        console.log(element.textContent.trim(), array);
